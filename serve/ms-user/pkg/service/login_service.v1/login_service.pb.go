...
const file_login_service_proto_rawDesc = "" +
	...
	"\x06mobile\x18\x01 \x01(\tR\x06mobile\"\x11\n" +
	"\x0fCaptchaResponse2c\n" +
	"\fLoginService\x12S\n" +
	"\n" +
	"GetCaptcha\x12 .login_service.v1.CaptchaMessage\x1a!.login_service.v1.CaptchaResponse\"\x00B#Z!ms-user/pkg/service/login.service.v1b\x06proto3"
...
var file_login_service_proto_goTypes = []any{
	(*CaptchaMessage)(nil),  // 0: login_service.v1.CaptchaMessage
	(*CaptchaResponse)(nil), // 1: login_service.v1.CaptchaResponse
}
var file_login_service_proto_depIdxs = []int32{
	0, // 0: login_service.v1.LoginService.GetCaptcha:input_type -> login_service.v1.CaptchaMessage
	1, // 1: login_service.v1.LoginService.GetCaptcha:output_type -> login_service.v1.CaptchaResponse

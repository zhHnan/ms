...
type DepartmentRepo interface {
	...
	FindDepartment(ctx context.Context, organizationCode int64, parentDepartmentCode int64, name string) (*account.Department, error)
	Save(dpm *account.Department) error
}
